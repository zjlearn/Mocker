            ...
            for (Field field : allFields) {
                ...
                if (fieldType == Integer.class || fieldType == int.class) {   //判断参数的类型，并根据类型做相应的初始化调用
                    ...
                    if (fieldName.contains("name")) {
                        field.set(instance, mock.names().val().substring(1, 9));
                        ...
                        field.set(fieldName, "0376-7209398");
                    } else if (fieldName.contains("mobile")) {
                        field.set(instance, "13016413998");
                    } else if (fieldName.contains("postcode")) {
                        field.set(instance, "310000");
                    } else {
                        field.set(instance, mock.strings().val());
                    }
                } else if (fieldType == Date.class)
